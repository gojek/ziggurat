...
(defproject tech.gojek/ziggurat "3.0.1-alpha.1"
  ...
  :dependencies [[bidi "2.1.6"]
                 ...
                 [io.opentracing.contrib/opentracing-kafka-streams "0.1.4" :exclusions [org.apache.kafka/kafka-streams org.slf4j/slf4j-api]]
                 [io.opentracing.contrib/opentracing-kafka-client "0.1.4" :exclusions [org.slf4j/slf4j-api]]
