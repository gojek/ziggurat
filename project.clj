...
(defproject tech.gojek/ziggurat "3.12.0-remove-state-store"
  ...
  :dependencies [[bidi "2.1.6"]
                 ...
                 [org.apache.kafka/kafka-streams "2.6.0" :exclusions [org.slf4j/slf4j-log4j12 log4j]]
  ...
  :profiles {:uberjar {:aot         :all
             ...
             :test    {:java-source-paths ["src/com" "test/com"]
                       ...
                       :dependencies      [[com.google.protobuf/protobuf-java "3.5.1"]
                                           ...
                                           [org.apache.kafka/kafka-streams "2.6.0" :classifier "test" :exclusions [org.slf4j/slf4j-log4j12 log4j]]
                                           [org.apache.kafka/kafka-clients "2.6.0" :classifier "test"]
